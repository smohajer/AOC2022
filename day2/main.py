...
def get_games():
    with open("input", "r") as f:
        file = f.readlines()
        return [score.strip() for score in file]


def numbers(score, game):
    return score[game]


def get_total_score_part(game_scores, score):
    return sum([numbers(score, game) for game in game_scores])
...
if __name__ == '__main__':
    ...
    print(get_total_score_part(scores, score1))
    print(get_total_score_part(scores, score2))
